...
class StreamingAuditDisplay(StreamingTextDisplay):
    ...
    def _batch_to_expanded_html(self, data: dict) -> str:
        ...
        html_parts = [
            ...
            '.batch-header { background: #f8f9fa; padding: 12px; border-radius: 6px; margin-bottom: 16px; width: 100%; box-sizing: border-box; }',
            ...
            '.image-section { margin-bottom: 20px; border: 1px solid #e0e0e0; border-radius: 6px; padding: 12px; background: #fff; width: 100%; box-sizing: border-box; }',
